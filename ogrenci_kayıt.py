...
mekatronik_muh = []
makina_muh = []
def silme_isim(makina_muh):

    print("SİLME İŞLEMLERİ")
    isim=input("SİLİNECEK İSİMİ  GİRİNİZ")
    indexx = 0
    for k in makina_muh:
        if (isim in k):
            makina_muh.pop(indexx)
        indexx += 1
    print(makina_muh)
...
def silme_no_not(y):
    print("SİLME İŞLEMLERİ")
    notu_sil=int(input("SİLİNECEK NOT VEYA NO GİRİİNİZ"))
    index=0
    for eleman in y:
        if notu_sil in eleman:
           y.pop(index)


def ort_guncelle(vize,odev,final):
    while True:
        ortaalaama = vize * 0.3 + odev * 0.2 + final * 0.5
        if  ortaalaama < 0 or    ortaalaama > 100:
            print("YANLIŞ ORTALAMA!!!")
            break

        else:
            durum="kaldı"
            if   ortaalaama >= 90 and ortaalaama < 100:
                durum = "AA"
            elif ortaalaama < 89 and ortaalaama >= 85:
                durum = "BA"
            elif ortaalaama >= 75 and ortaalaama < 79:
                durum = "CB"
            elif ortaalaama >= 70 and ortaalaama < 74:
                durum = "CC"
            elif ortaalaama >= 65 and ortaalaama < 69:
                durum = "DC"
            elif ortaalaama >= 60 and ortaalaama < 64:
                durum = "DD"
            elif ortaalaama >= 50 and ortaalaama < 59:
                durum = "FD"
            else:
                durum = "FF"
    return durum
        ...
        if secim1==1:
                ...
                for x in range(ekle_ogr_saysı):
                    ...
                    for h in range(ekle_ders_saysı):
                        ...
                        if eklenen_ort >= 90 and eklenen_ort < 100:
                            ...
                            durum1 = "FF"
                        top_bil=[ekle_ad,ekle_no,eklenen_ders,eklenen_vize,eklenen_odev,eklenen_final,eklenen_ort,durum1]
                ...
                for y in range(0,mek_ekle_ogr_saysı):
                    ...
                    for o in range(0,mek_ekle_ders_saysı):
                        ...
                        if mek_eklenen_ort < 0 or mek_eklenen_ort > 100:
                            ...
                            top_mek=[ mek_ekle_ad,mek_ekle_no, mek_eklenen_ders, mek_eklenen_vize,mek_eklenen_odev ,mek_eklenen_final, mek_eklenen_ort,durum2]
                ...
                for s in range(0,mak_ekle_ogr_saysı):
                    ...
                    for v in range(0,mak_ekle_ders_saysı):
                        ...
                        if mak_eklenen_ort < 0 or mak_eklenen_ort > 100:
                            ...
                            makina_muh.append([mak_ekle_ad, mak_ekle_no, mak_eklenen_ders, mak_eklenen_odev,mak_eklenen_ort, durum3])
                    print(makina_muh)
        elif secim1==2:
            ...
            if ad_degisim==1:
                ...
                for v in bilgisayar_muh:
                    if adı in v:
                        ...
                        print("BU BOLUMDE BOYLE BİR OGRENCİ YOKTUR")
                        break
                print(bilgisayar_muh)
            elif ad_degisim==2:
                ...
                for h in mekatronik_muh:
                    if adı1 in h:
                        ...
                        print("BU BOLUMDE BOYLE BİR OGRENCİ BULUNMAMAKTADIR")
                        break
                print(mekatronik_muh)
            ...
            if no_sec==1:
                ...
                for ind in bilgisayar_muh:
                    if degis_no in ind:
                        ...
                        print("GİRDİGİNİZ  NUMARALI BİR OGRENCİ BULUNMAMAKTADIR")
                        break
                print(bilgisayar_muh)
            elif no_sec==2:
            ...
            if bol_sec==1:
                ...
                if sınav_sec1 == 1:
                    ...
                    gir_odev2 = int(input("DEĞİŞTİRMEK İSTEDİĞİNİZ ODEVİ GİRİNİZ"))
                    yeni_odev2 = int(input("OGRENCİNİN YENİ NOTUNU GİRİNİZ"))
                    index_mek_odev = 0
                    ...
                    gir_final3 = int(input("DEĞİŞTİRMEK İSTEDİĞİNİZ FİNALİ GİRİNİZ"))
                    yeni_final3 = int(input("OGRENCİNİN YENİ NOTUNU GİRİNİZ"))
                    index_meek_final = 0
                ...
                if sınav_sec_33 == 1:
                    ...
                    gir_odev50 = int(input("DEĞİŞTİRMEK İSTEDİĞİNİZ VİZEYİ GİRİNİZ"))
...
while True:
    ...
    if secim == 1:
        ...
        if blgsyr_ogrnc_sayı < 0 or blgsyr_ogrnc_sayı > 20:
        ...
        if mekat_ogr_sayısı<0 or mekat_ogr_sayısı>20:
            ...
            for c in range(mekat_ogr_sayısı):
                ...
                for p in range(mekat_ders_sayısı):
                    ...
                    meka_vize = int(input("vize notunu giriniz"))
                    meka_odev = int(input("odev notunun giriniz"))
                    meka_final = int(input("final notunu giriniz"))
        ...
        if makn_ogr_says<0 or makn_ogr_says>20:
